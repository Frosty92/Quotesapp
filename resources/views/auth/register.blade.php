        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-login">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-xs-6">
                            <a href="{{route('login')}}" class="btn btn-success col-md-12" >Login</a>
                        </div>
                        <div class="col-xs-6">
                            <a href="{{route('register')}}" class="btn btn-info col-md-12">Register</a>
                        </div>
                    </div>
                    <hr>
                </div>
							...
							<div class="col-lg-12"> 
                                <form method="post" action="{{route('register')}}" role="form">
									...
									<div class="form-group">
                                    	...
                                    	<div class="form-group">
										<input type="password" name="password_confirm" tabindex="2" class="form-control" placeholder="Repeat password" required>
									</div>
									<div class="form-group">
										<div class="row">
